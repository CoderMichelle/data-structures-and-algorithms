...
const toLastNames = people => {
  ...
  const resultArr1 = people.map(person => `${person.firstName} ${person.lastName}`);
...
const addValues = (arr) => {
  const resultArr2 = arr.reduce((answerSoFar, currentValue) => {
...
const countNumberOfElements = (arr) => {
  const result = arr.reduce((answerSoFar, currentValue) => {
...
const returnNames = (arr) => {
  const resultArr5 = arr.reduce((answerSoFar, currentValue) => {
    return answerSoFar + currentValue.name;
  }, []);
...
const reversedString = (str) => {
  let arr = str.split('');
  let reversedString = arr.reduce((answerSoFar, currentValue) => {
