...
const raisedToTheThird = (arr) => {
  const resultsArr1 = arr.map(num => Math.pow(num, 3));
...
const addOne = (arr) => {
  const resultsArr2 = arr.map(num => num + 1);
...
const addQuestion = (arr) => {
  const resultsArr3 = arr.map(string => string + '?');
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    resultsArr4.push(Math.pow(2, arr[i]));
  }
  // arr.map(num => Math.pow(2, num));
  console.log(resultsArr4);
  return resultsArr4;
};
...
const forEachTwoToThe = (arr) => {
  const resultsArr5 = [];
  arr.forEach(num => resultsArr5.push(Math.pow(2, num)));
  return resultsArr5;
};
...
const mapTwoToThe = (arr) => {
  const resultsArr6 = arr.map(num => Math.pow(2, num));
...
const charCode = (arr) => {
  const resultsArr7 = arr.map(letter => letter.charCodeAt());
  console.log(resultsArr7);
  return resultsArr7;
};
...
const evenOdd = (arr) => {
  const resultsArr8 = arr.map(element => {
